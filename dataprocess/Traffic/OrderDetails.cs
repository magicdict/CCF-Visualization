    ...
    public struct Geo
    {
        ...
        public string POI
        {
            get
            {
                ...
                //景点
                if (lng >= 110.3474 - 0.001 && lng <= 110.3474 + 0.001 && lat >= 20.0495 - 0.001 && lat <= 20.0495 + 0.001) return "景点";  //骑楼
                if (lng >= 110.3556 - 0.001 && lng <= 110.5008 + 0.001 && lat >= 19.9251 - 0.001 && lat <= 19.9251 + 0.001) return "景点";  //火山公园
                if (lng >= 110.244 - 0.001 && lng <= 110.244 + 0.001 && lat >= 20.0425 - 0.001 && lat <= 20.0425 + 0.001) return "景点";    //海滩
